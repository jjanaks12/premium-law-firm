...
route.get('/me', [verifyAccessToken], profileController.profile);
route.put('/me', [verifyAccessToken], profileController.updateProfile);
route.post('/change-password', [verifyAccessToken], profileController.changePassword);
