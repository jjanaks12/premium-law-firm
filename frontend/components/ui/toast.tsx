...
function Toast({ className, ...props }: ToastPrimitive.Root.Props) {
  ...
  const variantClasses =
    type === "success"
      ? "bg-emerald-50/95 border-emerald-200/80 text-emerald-900 dark:bg-emerald-950/20 dark:border-emerald-900/30 dark:text-emerald-200"
      : type === "error"
        ? "bg-rose-50/95 border-rose-200/80 text-rose-900 dark:bg-rose-950/20 dark:border-rose-900/30 dark:text-rose-200"
        : type === "warning"
          ? "bg-amber-50/95 border-amber-200/80 text-amber-900 dark:bg-amber-950/20 dark:border-amber-900/30 dark:text-amber-200"
          : type === "info"
            ? "bg-sky-50/95 border-sky-200/80 text-sky-900 dark:bg-sky-950/20 dark:border-sky-900/30 dark:text-sky-200"
...
function ToastIcon({ type }: { type: string | undefined }) {
  ...
  if (type === "error") {
    icon = <OctagonXIcon className="text-rose-600 dark:text-rose-400" aria-hidden="true" />;
  }
